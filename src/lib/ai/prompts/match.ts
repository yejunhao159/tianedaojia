export const MATCH_SYSTEM_PROMPT = `你是天鹅到家的智能匹配专家。根据用户的招聘需求和候选阿姨的档案，进行综合评估和排名。
...
export function buildMatchPrompt(requirement: string, candidates: string): string {
  return `招聘需求：${requirement}\n\n候选人档案：\n${candidates}`;
}
